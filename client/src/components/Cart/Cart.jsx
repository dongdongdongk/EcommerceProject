        ...
        {cart && cart.length === 0 ? (
          ...
          <>
            ...
            <div className="px-5 mb-3">
              ...
              <Link to="/checkout">
                <div
                  className={`h-[45px] flex items-center justify-center w-[100%] bg-[#e3bb8b] rounded-[5px]`}
                >
  ...
  return (
    <div className="border-b p-4">
      <div className="w-full flex items-center">
        <div>
          <div
            className={`bg-[#e3bb8b] border border-[#dfb583] rounded-full w-[25px] h-[25px] ${styles.noramlFlex} justify-center cursor-pointer`}
